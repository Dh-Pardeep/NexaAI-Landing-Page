        ...
        <Container >
          <nav className='d-flex justify-content-between align-items-center py_30'>
            ...
            <ul className={`${showNavbar ? 'd-flex align-items-center mb-0 nav_sm p-0 gap_20 Nav_hover ms-lg-5 ms-0' : ' gap_20 d-flex align-items-center mb-0 nav_sm nav_show p-0'} `}>
              <li><a href="#" onClick={() => setShowNavbar(true)} className='text_white position-relative Nav_Btn_hover ms-lg-5 d-inline-block font_xs fw-normal ff_Poppins '>Home</a></li>
              ...
              <li><a href="#About" onClick={() => setShowNavbar(true)} className='text_white position-relative Nav_Btn_hover d-inline-block font_xs fw-normal ff_Poppins '>About</a></li>
              <li><a href="#Nexchat" onClick={() => setShowNavbar(true)} className='text_white position-relative Nav_Btn_hover d-inline-block font_xs fw-normal ff_Poppins '>Nexchat</a></li>
              <li><a href="#Tokens" onClick={() => setShowNavbar(true)} className='text_white position-relative Nav_Btn_hover d-inline-block font_xs fw-normal ff_Poppins '>Tokens</a></li>
