        ...
        <Container className=' pt-4 pt-md-5'>
          <Row className=' justify-content-end justify-content-lg-start'>
            <Col sm={8} md={6} lg={6} className='my-lg-5' >
              <div className='pb-lg-5 pb-3 ps-lg-5 ' data-aos="fade-right" data-aos-delay="3000">
                <h1 className='text_white font_4xl ff_Recharge fw-bold mb-0 mb-4 position-relative z-1'><span className='text_green'>Nexai</span> is an advanced AI-powered home assistant</h1>
